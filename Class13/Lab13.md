...
![](Lab13_files/figure-commonmark/unnamed-chunk-6-1.png)
...
Log2 transfirmation has a nice property, where no change will make the
log2 value zero, doubling will lead log2 to be 1 and halving will lead
it to be -1.
...
We want to add on gene symbols (i.e. gene names) and other common
...
To runn gage we need to provide it with a vector of FC values (not our
full big results table.
...
```
    ...
    Info: Working in directory /Users/bernicelozada/Desktop/BIMM 143/bimm143_github/Class13
